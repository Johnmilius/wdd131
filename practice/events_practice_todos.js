// events.js
let tasks = [];
let enterBox = document.getElementById('submitTask');
...
function newTask() {
  ...
  // render out the list
    let outputText = document.getElementById('todo').value
    tasks.push({detail: outputText, completed: false})
    renderTasks(tasks);
}
...
enterBox.addEventListener('click', newTask);